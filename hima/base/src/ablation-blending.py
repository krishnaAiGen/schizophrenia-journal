# -*- coding: utf-8 -*-
"""
Ablation Study: Is Blending Necessary or Just Complexity?

This script performs model-side ablation to answer:
...
# ============================================================
# DATA PREPROCESSING (same as intial_code.py)
# ============================================================
...
# ============================================================
print("\n" + "="*70)
print("ABLATION STUDY: IS BLENDING NECESSARY OR JUST COMPLEXITY?")
print("="*70)
...
# ============================================================
print("\n" + "="*70)
print("PART 1: INDIVIDUAL MODEL PERFORMANCE (Same Feature Set)")
print("="*70)
...
axes[0].set_title('Single Models vs Blending', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/Users/krishnayadav/Documents/test_projects/schizophrenia-journal/krishna/base/result/ablation_blending_comparison.png', dpi=150)
plt.close()
print("\nSaved: result/ablation_blending_comparison.png")
...
plt.title('ROC Curve: Best Single Model vs Blending', fontsize=14, fontweight='bold')
plt.legend(loc="lower right", fontsize=10)
plt.grid(alpha=0.3)
plt.tight_layout()
plt.savefig('/Users/krishnayadav/Documents/test_projects/schizophrenia-journal/krishna/base/result/ablation_roc_comparison.png', dpi=150)
plt.close()
print("Saved: result/ablation_roc_comparison.png")
