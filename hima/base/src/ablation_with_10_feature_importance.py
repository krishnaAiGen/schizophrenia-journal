# -*- coding: utf-8 -*-
"""
Ablation Study with Top 10 Features
Based on ablation-blending.py but using only the top 10 most important features.

Top 10 Features:
1. FIXATION_COUNT
2. FPCI
3. Total Saccade Amplitude
4. FSI
5. OEI
6. Pupil size ratio
7. Dynamic range of pupil size
8. AVERAGE_FIXATION_DURATION
9. SACCADE_COUNT
10. PRR
"""
...
# ============================================================
# DATA PREPROCESSING (Based on feature_importance.py)
# ============================================================
print("\n" + "="*70)
print("LOADING AND PREPROCESSING DATA (Top 10 Features)")
print("="*70)

# Load the dataset with 20 features
...
# ============================================================
print("\nFiltering data to keep only the Top 10 Features...")
...
top_10_features = [
    ...
    'OEI', 
    'Pupil size ratio', 
    'Dynamic range of pupil size', 
    'AVERAGE_FIXATION_DURATION', 
    'SACCADE_COUNT', 
    'PRR',
    'class'  # Keep target class
]

# Verify all features exist
sample_columns = dfs[0].columns.tolist()
missing_features = [f for f in top_10_features if f not in sample_columns]
if missing_features:
    raise ValueError(f"The following requested features are missing from dataframe: {missing_features}")

# Subset dataframes
for i in range(len(dfs)):
    dfs[i] = dfs[i][top_10_features]

print(f"Features selected: {[f for f in top_10_features if f != 'class']}")
print("Data preprocessing complete. Total subjects:", len(dfs))

# ============================================================
# HELPER FUNCTIONS (Same as ablation-blending.py)
# ============================================================
...
# ============================================================
print("\n" + "="*70)
print("ABLATION STUDY: IS BLENDING NECESSARY (TOP 10 FEATURES)?")
print("="*70)
...
# ============================================================
print("\n" + "="*70)
print("PART 1: INDIVIDUAL MODEL PERFORMANCE (Same 10 Feature Set)")
print("="*70)
...
# ============================================================
print("\n" + "="*70)
print("ABLATION STUDY SUMMARY (TOP 10 FEATURES)")
print("="*70)
...
# ============================================================
print("\n" + "="*70)
print("CONCLUSION: IS BLENDING NECESSARY?")
print("="*70)
...
axes[0].set_title('Single Models vs Blending (Top 10 Features)', fontsize=14, fontweight='bold')
...
axes[1].set_title('Leave-One-Model-Out Impact', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('/Users/krishnayadav/Documents/test_projects/schizophrenia-journal/krishna/base/result/ablation_10_features_blending_comparison.png', dpi=150)
plt.close()
print("\nSaved: result/ablation_10_features_blending_comparison.png")
...
plt.title('ROC Curve: Best Single Model vs Blending (Top 10 Features)', fontsize=14, fontweight='bold')
plt.legend(loc="lower right", fontsize=10)
plt.grid(alpha=0.3)
plt.tight_layout()
plt.savefig('/Users/krishnayadav/Documents/test_projects/schizophrenia-journal/krishna/base/result/ablation_10_features_roc_comparison.png', dpi=150)
plt.close()
print("Saved: result/ablation_10_features_roc_comparison.png")

print("\n" + "="*70)
print("ABLATION STUDY COMPLETE (TOP 10 FEATURES)")
print("="*70)
